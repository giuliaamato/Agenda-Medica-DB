...
SELECT MAX(VisiteEffettuate) AS Visite, T.CFInfermiere AS CodiceFiscale
...
# maggiore di 30000, il nome utente comprende una ca_ 
...
SELECT T1.CodiceASL, MAX(T1.CountInf) FROM (SELECT COUNT(Infermiere.CodiceFiscale) 
