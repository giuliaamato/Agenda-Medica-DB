<?php
  ...
  if ($_SERVER['REQUEST_METHOD']=='POST' && isset($_POST['nome']) && isset($_POST['cognome']) && isset($_POST['gridRadios']) && isset($_POST['birthday']) && isset($_POST['email']) && isset($_POST['tel']) && isset($_POST['cNascita']) && isset($_POST['cResidenza']) && isset($_POST['username']) && isset($_POST['stipendio']) && isset($_POST['indirizzo']) && isset($_POST['gridRadios2'])){
    ...
    exec('python make_cf.py '.$nome.' '.$cognome.' '.$data_nascita.' '.$sesso.' '.$citta_nascita,$output,$ret_code);
    
    
    $cf_nuovo_infermiere = $output[0];
...
<div class="container">
	...
	<form method='POST' action='#'>
      ...
      <br />
      <p class='text-center'><b> N.B. : Il Codice Fiscale verrà generato automaticamente dal server</b> </p>
      <br />
