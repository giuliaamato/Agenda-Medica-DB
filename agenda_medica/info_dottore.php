...
<?php
  ...
  if (isset($_SESSION['username']) && $_SESSION['logged_in'] == true){
    ...
    echo "<a class='navbar-brand' href='http://localhost/agenda_medica/welcomepage.html'>Pagina iniziale</a>";
    echo "</div>";
...
<?php
  ...
  if (!isset($_SESSION['username']) && !$_SESSION['logged_in'] == true){
    ...
    echo "<p><a role='button' class='btn btn-primary' href='welcomepage.html'>Torna alla pagina principale</a></p>";  
